...
- Current automated fixtures validate deterministic structure, edge behavior, and real Prophet execution; production-scale benchmark thresholds still require the final source contract.
...
- Whether missing future regressors should reject the full run or permit partial forecast publication.
